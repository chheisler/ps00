...
; Examples:
; (part-height (make-person "John" "Snow" 25 175 75) "torso") =>
;   (* 175 TORSO-HEIGHT)
...
; Examples:
; (part-width (make-person "John "Snow" 25 175 75) "leg") =>
;    (* 75 LEG-WIDTH)
...
(check-expect (part-height (make-person "John" "Snow" 25 175 75) "torso")
  (* 175 TORSO-HEIGHT))
(check-expect (part-width (make-person "John" "Snow" 25 175 75) "leg")
  (* 75 LEG-WIDTH))
...
; Examples:
; (head-image (make-person "John" "Snow" 25 175 75)) =>
...
; Examples:
; (torso-image (make-person "John" "Snow" 25 175 75)) =>
...
; Examples:
; (arm-image (make-person "John" "Snow" 25 175 75)) =>
...
; Examples:
; (arm-gap-image (make-person "John" "Snow" 25 175 75)) =>
...
(check-expect (head-image (make-person "John" "Snow" 25 175 75))
  (circle (/ (* 175 HEAD-PROP) 2) "solid" "black"))
(check-expect (torso-image (make-person "John" "Snow" 25 175 75))
  (rectangle (* 75 TORSO-WIDTH) (* 175 TORSO-HEIGHT) "solid" "black"))
(check-expect (arm-image (make-person "John" "Snow" 25 175 75))
  (rectangle (* 75 ARM-WIDTH) (* 175 ARM-HEIGHT) "solid" "black"))
(check-expect (arm-gap-image (make-person "John" "Snow" 25 175 75))
  (rectangle ARM-GAP (* 175 TORSO-HEIGHT) "solid" "white"))
